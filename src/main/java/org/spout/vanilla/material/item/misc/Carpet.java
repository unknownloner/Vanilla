...
public class Carpet extends Solid implements Burnable {
	...
	public static final Carpet GRAY_CARPET = new Carpet("Gray Carpet", WoolColor.GRAY, WHITE_CARPET, null);
	public static final Carpet SILVER_CARPET = new Carpet("Light Gray Carpet", WoolColor.SILVER, WHITE_CARPET, null);
	public static final Carpet CYAN_CARPET = new Carpet("Cyan Carpet", WoolColor.CYAN, WHITE_CARPET, null);
	public static final Carpet PURPLE_CARPET = new Carpet("Purple Carpet", WoolColor.PURPLE, WHITE_CARPET, null);
	public static final Carpet BLUE_CARPET = new Carpet("Blue Carpet", WoolColor.BLUE, WHITE_CARPET, null);
	public static final Carpet BROWN_CARPET = new Carpet("Brown Carpet", WoolColor.BROWN, WHITE_CARPET, null);
	public static final Carpet GREEN_CARPET = new Carpet("Green Carpet", WoolColor.GREEN, WHITE_CARPET, null);
	public static final Carpet RED_CARPET = new Carpet("Red Carpet", WoolColor.RED, WHITE_CARPET, null);
	public static final Carpet BLACK_CARPET = new Carpet("Black Carpet", WoolColor.BLACK, WHITE_CARPET, null);
